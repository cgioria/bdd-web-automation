  @selenium
  Feature: Pago DEUDOR por archivo OBE
   # DEUDOR 300/OBSERVACION 4
   # DEUDOR 301/OBSERVACION 5
   # DEUDOR 302/OBSERVACION 6
   #
   #
   #
  ...
  Scenario: 1 Debito directo pago total
   Given Inicializo la app en la URL https://10.241.161.205:44301/pago/publicacion?uTbcCawGNW%2bVRfV4XXubTQ%3d%3d
   ...
   And Tomar Captura: 5CompPagoDebDir
   Then cierro la app


  @regression
  Scenario: 2 Pago Informado ECHEQ
   Given Inicializo la app en la URL https://10.241.161.205:44301/pago/publicacion?teCxgeVRoqyuXrMT7rF2Mg%3d%3d
   And Cargo el DOM de la App: obe
   ...
   #And Escribo Nro Pago Sup
   And Capturo pantalla: Pago
   And Tomar Captura: 5CompPagoInfEch
   Then cierro la app
  ...
  Scenario: 3 Pago Supervielle
   ...
   And Espero 3 segundos
   And Capturo pantalla: Pago
   And Tomar Captura: 5CompPagoSup
   Then cierro la app

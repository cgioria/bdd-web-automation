  @selenium
  Feature: Pago DEUDOR  por archivo SFTP

  # DEUDOR 305/OBSERVACION 6
  # DEUDOR 304/OBSERVACION 5
  # DEUDA 305/CUOTA 4 CON RECARGO DE AGOSTO
  # DEUDOR 303/OBSERVACION 4
  #
  #

  @regression
  Scenario: 1 Debito directo pago total
   Given Inicializo la app en la URL https://10.241.161.205:44301/pago/publicacion?zaTjsvTPSApwW6uNPRjiwQ%3d%3d
   ...
   And En el num Importe Pendiente escribo 777
   ...
   And Tomar Captura: 4CompPagoDebDir
   Then cierro la app


  @regression
  Scenario: 2 Pago Informado ECHEQ
   Given Inicializo la app en la URL https://10.241.161.205:44301/pago/publicacion?Wd6yT4Qgtn8Eamew4Ff9bA%3d%3d
   And Cargo el DOM de la App: obe
   ...
   #And Escribo Nro Pago Sup
   And Capturo pantalla: Pago
   And Tomar Captura: 4CompPagoInfEch
   Then cierro la app
  ...
  Scenario: 3 Pago Supervielle
   ...
   And Espero 3 segundos
   And Capturo pantalla: Pago
   And Tomar Captura: 4CompPagoSup
   Then cierro la app


  @regression
  Scenario: 4.1 Tarjeta de Credito Visa
   Given Inicializo la app en la URL https://10.241.161.205:44301/pago/publicacion?43S3m0tYItfFJ7%2f21ljrFw%3d%3d
   And Cargo el DOM de la App: obe
   ...
   And Espero 3 segundos
   And Capturo pantalla: Pago
   And Tomar Captura: 4CompPagoTCredito
   Then cierro la app
